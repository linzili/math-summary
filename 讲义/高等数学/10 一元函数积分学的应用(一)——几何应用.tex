...
\begin{enumerate}
    ...
    \item \textbf{平均值公式}
          ...
          $$
    \item \textbf{平面上的曲边梯形的形心}
          \begin{enumerate}
              \item 形心横坐标 $$\bar{x} = \frac{\iint_{D} x \, d\sigma}{\iint_{D} d\sigma} = \frac{\int_{a}^{b} dx \int_{0}^{f(x)} x \, dy}{\int_{a}^{b} dx \int_{0}^{f(x)} dy} = \frac{\int_{a}^{b} x f(x) \, dx}{\int_{a}^{b} f(x) \, dx};$$
              \item 形心纵坐标 $$ \bar{y} = \frac{\iint_{D} y \, d\sigma}{\iint_{D} d\sigma} = \frac{\int_{a}^{b} dx \int_{0}^{f(x)} y \, dy}{\int_{a}^{b} dx \int_{0}^{f(x)} dy} = \frac{1}{2} \frac{\int_{a}^{b} f^{2}(x) \, dx}{\int_{a}^{b} f(x) \, dx}.$$
          \end{enumerate}
    \item \textbf{平面曲线的弧长}
          \begin{enumerate}
              \item 直角坐标方程 $y = y(x)$：
