...
\usepackage{centernot}  % 在主要数学包之后加载
\usepackage{mathdots}
...
\mainmatter
\input{高等数学/0 零基础.tex}
\input{高等数学/1 函数极限与连续.tex}
\input{高等数学/2 数列极限.tex}
\input{高等数学/3 一元函数微分学的概念.tex}
\input{高等数学/4 一元函数微分学的计算.tex}
\input{高等数学/5 一元函数微分学的应用(一)——几何应用.tex}
\input{高等数学/6 一元函数微分学的应用(二)——中值定理、微分等式与微分不等式.tex}
\input{高等数学/7 一元函数微分学的应用(三)——物理应用.tex}
\input{高等数学/8 一元函数积分学的概念与性质.tex}
\input{高等数学/9 一元函数积分学的计算.tex}
\input{高等数学/10 一元函数积分学的应用(一)——几何应用.tex}
\input{高等数学/11 一元函数积分学的应用(二)——积分等式与积分不等式.tex}
\input{高等数学/12 一元函数积分学的应用(三)——物理应用.tex}
\input{高等数学/13 多元函数微分学.tex}
\input{高等数学/14 二重积分.tex}
\input{高等数学/15 微分方程.tex}
\input{高等数学/16 无穷级数.tex}
\input{高等数学/17 多元函数积分学的预备知识.tex}
\input{高等数学/18 多元函数积分学.tex}
\input{线性代数/1 行列式.tex}
\input{线性代数/2 余子式和代数余子式的计算.tex}
\input{线性代数/3 矩阵运算.tex}
\input{线性代数/4 矩阵的秩.tex}
\input{线性代数/5 线性方程组.tex}
\input{线性代数/6 向量组.tex}
\input{线性代数/7 特征向量与特征值.tex}
\input{线性代数/8 相似理论.tex}
\input{线性代数/9 二次型.tex}
\input{概率论与数理统计/1 随机事件和概率.tex}
\input{概率论与数理统计/2 一维随机变量及其分布.tex}
\input{概率论与数理统计/3 一位随机变量函数的分布.tex}
\input{概率论与数理统计/4 多维随机变量及其分布.tex}
\input{概率论与数理统计/5 多维随机变量函数的分布.tex}
\input{概率论与数理统计/6 数字特征.tex}
\input{概率论与数理统计/7 大数定律与中心极限定理.tex}
\input{概率论与数理统计/8 统计量及其分布.tex}
\input{概率论与数理统计/9 参数估计与假设检验.tex}
